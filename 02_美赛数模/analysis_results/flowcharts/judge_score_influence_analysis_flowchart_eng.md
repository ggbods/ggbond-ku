# Judge Score Influence Analysis - Code Flowchart
...
2. **Load Data**: Read the necessary CSV files containing judge score data and other relevant information.

3. **Preprocess Data**: Handle missing values and prepare the data for analysis.

4. **Calculate Feature Importance**: Use Random Forest algorithm to determine the importance of different features in predicting judge scores.
